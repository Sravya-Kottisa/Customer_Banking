...
def main():
    ...
    print(f"Savings Account - Interest Earned: ${interest_earned:.2f}, Updated Balance: ${updated_savings_balance:.2f} for {savings_maturity} months")
    ...
    print(f"CD Account - Interest Earned: ${interest_earned:.2f}, Updated Balance: ${updated_cd_balance:.2f} for {cd_maturity} months")
